...
// #242: pure window-math for per-user quiet hours. Framework-free (no expo/db
// imports) so it runs under plain node:test — mirrors
// apps/api/src/lib/quietHours.ts's tests verbatim (see that file's header for
// why the two copies must stay in sync).
