...
async function loadMigrations(): Promise<Migration[]> {
  ...
  const { migration: m055 } = await import('./migrations/055_vehicle_fuel_level');
  const { migration: m056 } = await import('./migrations/056_repair_steps');
  const { migration: m057 } = await import('./migrations/057_repair_parts_step_id');
  const { migration: m058 } = await import('./migrations/058_rooms_media_room');
  const { migration: m059 } = await import('./migrations/059_schedule_assignments');
  const { migration: m060 } = await import('./migrations/060_dashboard_prefs');
  const { migration: m061 } = await import('./migrations/061_outbox_denied');
