// Station D3: ported from apps/mobile/src/components/QrSigningSection.tsx.
// Import mapping: themedAlert/useThemedStyles → '@invenpro/ui'; useDbQuery →
// '@invenpro/core'; scan/qrSignConfig already lives at the same v2 path.
import { View, Text, TouchableOpacity, Switch, StyleSheet } from 'react-native';
import type { Theme } from '@invenpro/ui';
import { Alert, useThemedStyles } from '@invenpro/ui';
...
/**
 * Admin control for QR label signing (Settings → Security). Signing adds a
...
export function QrSigningSection() {
  ...
  // whose own table bump already drives this read, so no hand-rolled version
  // counter is needed.
