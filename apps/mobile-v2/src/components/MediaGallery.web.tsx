// Station D2: ported from apps/mobile/src/components/MediaGallery.web.tsx.
// Same import mapping as the native twin; delete wraps
// runInTransaction(deleteMedia + logMediaAction) since v2 repos don't self-log.
...
import { getRooms, addRoom, type Room } from '../repos/rooms';
