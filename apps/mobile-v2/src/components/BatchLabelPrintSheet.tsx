// Station D2: ported from apps/mobile/src/components/BatchLabelPrintSheet.tsx.
// Import mapping: themedAlert/ui primitives/theme hooks -> '@invenpro/ui';
// '../db/queries/labelTemplates' -> '../repos/labelTemplates' (read-only —
// the template DESIGNER is dropped; printing with existing custom templates
// and the fixed presets stays).
import React, { useState, useMemo } from 'react';
import { View, Text, StyleSheet } from 'react-native';
import type { Theme } from '@invenpro/ui';
import { Alert, ModalSheet, PrimaryButton, FilterChip, useThemedStyles } from '@invenpro/ui';
import {
  printLabels,
...
import { getLabelTemplates } from '../repos/labelTemplates';
