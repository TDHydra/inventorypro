...
import type { ScheduleAssignmentView } from '../../repos/schedule';
...
// spanning assignment chips absolutely positioned on top. Ported from
// apps/mobile/src/components/schedule/EmployeeScheduleRow.tsx (import mapping
// only — layout/behavior unchanged, incl. the shared-horizontal-ScrollView
// design DayBoardScreen relies on).
