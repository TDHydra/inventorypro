...
import { useThemedStyles, FieldLabel, FormScreen, SegmentedControl, QuantityStepper } from '@invenpro/ui';
...
export default function StockQuickAdd({ onSaved }: Props) {
  ...
  function handleSave(qtyOverride?: number) {
    ...
    if (mode === 'set') {
      ...
      // upsertStock already mirrors this INSERT to the outbox internally
      // (repos/items.ts routes it through stockRepo) — do not append again.
