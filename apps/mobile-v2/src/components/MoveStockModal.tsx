...
import { Alert, confirmDestructive } from '@invenpro/ui';
import type { Theme } from '@invenpro/ui';
import { useThemedStyles, ModalSheet, PrimaryButton, AppInput, FieldLabel } from '@invenpro/ui';
 ...
 *   2. adjustStock(itemId, fromLocationId, -qty)  [deducts from source; repo
 *      mirrors the outbox ADJUST for us — no manual appendOutbox here]
 *   3. adjustStock(itemId, destId, +qty)          [adds to destination; same]
      ...
      onConfirm: () => {
        try {
          ...
          runInTransaction(() => {
            ...
            // adjustStock (repos/items.ts) mirrors its own outbox ADJUST via
            // stockRepo.mirror() — do NOT append a second outbox entry here.
