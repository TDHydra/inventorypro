// Station D3: ported from apps/mobile/src/components/NotificationRoutingEditor.tsx.
// Import mapping: db/appConfig + useTableVersion → '@invenpro/core';
// db/queries/{teams,users} → '../repos/*'; themes/useThemedStyles →
// '@invenpro/ui'. Rendered inline on settings/notifications (the old app's
// standalone notification-routing screen was absorbed by the settings split).
import { useMemo, useState } from 'react';
import { View, Text, TouchableOpacity, StyleSheet } from 'react-native';
import type { Theme } from '@invenpro/ui';
import { useThemedStyles } from '@invenpro/ui';
import { getAppConfig, useTableVersion } from '@invenpro/core';
...
interface Props {
  /** Synced config writer — the settings page passes its `setAppConfigSynced`. */
  onSave: (key: string, value: string) => void;
}

// Admin editor for the notification routing channels. Each channel gets
