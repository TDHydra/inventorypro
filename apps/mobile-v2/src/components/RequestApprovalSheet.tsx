// Ported from apps/mobile/src/components/RequestApprovalSheet.tsx.
// Import mapping applied (docs/REBUILD-PORTING.md):
//   '../lib/themedAlert' (Alert), ui/ModalSheet, ui/PrimaryButton,
//     ui/AppInput, ui/FieldLabel, useThemedStyles → '@invenpro/ui'
//   '../db/queries/notifications' (createApprovalRequest) → '../repos/approvals'
//   '../sync/engine' (syncNow) → '@invenpro/core'
//   '../db/maintenance' (isWriteBlocked) → unchanged path
import { useState } from 'react';
import { Text, ScrollView, TouchableOpacity, StyleSheet } from 'react-native';
import type { Theme } from '@invenpro/ui';
import { Alert, useThemedStyles, ModalSheet, PrimaryButton, AppInput, FieldLabel } from '@invenpro/ui';
import { syncNow } from '@invenpro/core';
import { useSession } from '../hooks/useSession';
import { createApprovalRequest } from '../repos/approvals';
 ...
 * approvers and pushes them an inbox notification (not ported this wave — see
 * app/(app)/approvals/index.tsx's own header comment).
 */
