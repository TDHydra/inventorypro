...
import { Alert, Card, EmptyState, useThemedStyles, type Theme } from '@invenpro/ui';
...
import {
  ...
  grantUnitAccessWithDefaults,
} from '../../repos/access';
import { ROLE_DISPLAY_NAMES, type UserRole } from '../../constants/roles';
import { AccessListEditor, type AccessEntry } from '../crew/AccessListEditor';
...
// alongside canManageVehicle's existing sibling in that same file.
