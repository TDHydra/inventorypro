...
import { upsertItem, getItemBySku, getItemByBarcode } from '../repos/items';
import type { InventoryItem } from '../repos/items';
import { appendLog } from '../db/queries/log';
import { useSession } from '../hooks/useSession';
import { useMaintenanceMode } from '../hooks/useMaintenanceMode';
import { getItemTypes, parseItemTypeMeta, getProductClasses } from '../repos/taxonomy';
...
import { useTheme, useThemedStyles, PrimaryButton, FieldLabel, MaintenanceBanner } from '@invenpro/ui';
    ...
    try {
      runInTransaction(() => {
        for (const row of validRows) {
          ...
          // upsertItem already mirrors this write to the outbox internally
          // (repos/items.ts routes it through itemsRepo.insert()) — do not append again.
          upsertItem(item);
          appendLog({
            action: 'item_created',
            entity_type: 'item',
