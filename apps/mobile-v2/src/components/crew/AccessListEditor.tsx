// Ported verbatim from apps/mobile/src/components/crew/AccessListEditor.tsx.
// Import mapping applied (docs/REBUILD-PORTING.md):
//   '../../lib/themedAlert' (Alert), ui/PrimaryButton, ui/ModalSheet,
//     ui/ConfirmSheet (confirmSheet), useThemedStyles → '@invenpro/ui'
//   '../SearchablePicker' → '../SearchablePicker' (unchanged path)
import { useState } from 'react';
import { View, Text, ScrollView, TouchableOpacity, StyleSheet } from 'react-native';
import type { Theme } from '@invenpro/ui';
import { Alert, useThemedStyles, ModalSheet, PrimaryButton, confirmSheet } from '@invenpro/ui';
...
// generalized into a reusable ModalSheet. The caller owns ALL persistence:
// `onAdd`/`onRemove` do the writes (and may be async / may throw — failures
// alert here and leave the sheet open), and the caller refreshes `entries`
// afterwards. First mobile-v2 consumer: unit_access grants (MemberPermissionsSheet
// per-unit editor, myteam.tsx "My Lockers", access/index.tsx).
