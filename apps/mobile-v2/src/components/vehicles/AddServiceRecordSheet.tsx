...
import {
  Alert, FormSheet, SegmentedControl, TextField, DateField, FieldLabel,
  confirmSheet, useTheme, useThemedStyles, type Theme,
} from '@invenpro/ui';
...
//
// Receipt PHOTO capture (expo-image-picker + uploadMediaAsset) and its "no
// photo? save anyway" confirm nudge — CUT at Station C3, restored Station D2
// once src/media landed. The upload runs AFTER the record's transaction
// commits, so a failed upload never loses the receipt.
// Station C3 deviation kept: createServiceRecord no longer self-logs (the
