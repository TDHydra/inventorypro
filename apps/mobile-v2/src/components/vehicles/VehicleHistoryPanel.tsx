...
import { Card, StatusPill, OdometerRoll, useThemedStyles, type Theme } from '@invenpro/ui';
import { useTableVersion } from '@invenpro/core';
import { ServiceRecordList } from './ServiceRecordList';
import { getCheckoutHistory, getOdometerTimeline, getFuelUps } from '../../repos/vehicles';
import { formatSince, serviceTypeLabel, parseFuelUpGallons, odometerDeltas } from './vehicleSessionLogic';
 ...
 *
 * Station C3: straight port — all reads, no self-log conversion needed.
 */
interface Props {
  locationId: string;
