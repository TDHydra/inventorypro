// Ported verbatim from apps/mobile/src/equipment/depreciation.ts — no imports
// to remap (pure math, zero dependencies). Not in this wave's explicit repo
// ownership list, but needed by the equipment detail screen's financial book-
// value display (view_financial_data-gated), sits alongside cleanliness.ts in
// the same src/equipment/ domain folder, and isn't owned by any other Wave A
// agent — ported here rather than reimplemented inline.
//
