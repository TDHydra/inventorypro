// Station D1: straight port of apps/mobile/src/chat/mentions.ts (#241). Pure
// @mention parser for chat messages. DB/React-free so it stays unit-testable
// (mirrors discussDraft.ts's pure-builder pattern). No autocomplete UI for v1
// — this only runs at send time against the CURRENT conversation
// participants, matching "@<display name>" (case-insensitive).
//
