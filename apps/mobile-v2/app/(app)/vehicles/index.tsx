// Ported from apps/mobile/app/(app)/(vehicles)/index.tsx (was a parenthesized
// group; plain route here per docs/REBUILD-PORTING.md / Station C3).
//
// Import mapping applied:
//   '../../../src/db/queries/access' (getVisibleUnits, getTeamUnits) → '../../../src/repos/access'
//   '../../../src/db/queries/vehicles' → '../../../src/repos/vehicles'
//   '../../../src/db/queries/users' → '../../../src/repos/users'
//   '../../../src/hooks/useDataVersion' (useTableVersion) → '@invenpro/core'
//   ui/EmptyState, ui/SegmentedControl → '@invenpro/ui'
//   router pathname '/(app)/(vehicles)/[id]' → '/(app)/vehicles/[id]' (plain route)
// Straight port otherwise.
import { useMemo, useState } from 'react';
import { View, Text, ScrollView, TouchableOpacity, StyleSheet } from 'react-native';
import { Stack, useRouter } from 'expo-router';
import { EmptyState, SegmentedControl, useThemedStyles, type Theme } from '@invenpro/ui';
...
import { getVisibleUnits, getTeamUnits } from '../../../src/repos/access';
import { isVehicleAvailableForCheckout, getActiveCheckout } from '../../../src/repos/vehicles';
