...
import { useThemedStyles, SelectField, DragList } from '@invenpro/ui';
import { setAppConfigLocal, appendOutbox, useTableVersion } from '@invenpro/core';
import { usePermission } from '../../../src/hooks/usePermission';
import { getAssignableCrews, getWeekBoundary, getRotation } from '../../../src/repos/oncall';
import type { WeekStartsOn } from '../../../src/components/oncall/weekMath';

// Station C2: ported from apps/mobile/app/(app)/(admin)/on-call-settings.tsx
// (plain route here, not a parenthesized group, per docs/REBUILD-PORTING.md).
// Import mapping: '../../../src/db/appConfig'+'../../../src/sync/outbox'+
// '../../../src/hooks/useDataVersion' -> '@invenpro/core', ui/* ->
// '@invenpro/ui', '../../../src/db/queries/oncall' -> '../../../src/repos/oncall'.
//
// Writes a synced `app_config` value: locally + through the outbox so it
// reaches the server (same write path as orgTheme.ts's setOrgDefaultTheme —
